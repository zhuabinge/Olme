...
public class AnswerGetDataTask  extends AsyncTask<Void, Void, HashMap<String, Object>> {
    ...
    public AnswerGetDataTask(LinkedList<HashMap<String, Object>> list, PullToRefreshListView pullToRefreshListView, SimpleAdapter adapter) {
        this.list = list;
    ...
    protected HashMap<String, Object> doInBackground(Void... params) {
        ...
        map.put("id", "199101");
        map.put("name", "Jordan");
        map.put("vedioLength", "2012-09-01");
        map.put("rating", "testse");
